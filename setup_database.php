...
try {
    ...
    $products = [
        ...
        ['category_id' => $feedCatId, 'name' => 'Kind Premium Mix', 'slug' => 'kind-premium-mix', 'product_type' => 'feed', 'price' => 3100, 'stock_quantity' => 200, 'description' => 'Our signature blend. Multi-purpose feed suitable for all poultry types.'],
